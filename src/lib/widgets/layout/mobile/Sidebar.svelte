...
<aside class="fixed top-16 transition-all-300 w-100% bg-pink-900 flex flex-col z-10" class:left--100%={!sideVisible} class:left-0={sideVisible}>
    ...
    <SideSubLink href="/events">Event</SideSubLink>
    <SideSubLink href="/updates">Uppdateringar</SideSubLink>
