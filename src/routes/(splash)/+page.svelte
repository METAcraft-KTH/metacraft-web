...
<div class="w-100% bg-dark-oak-planks flex flex-col items-center py-12 px-2 gap-4 md:gap-8 leading-tight">
  ...
  <div class="mx-2 mb-12 w-100% max-w-50rem md:p-10 text-base flex flex-col items-center gap-4">
    ...
    <a href="https://forms.gle/aUhgyC99nNAQXGS37" target="_blank" class="bg-map inline-block p-4 hover:scale-105 hover:contrast-120 transition-all"><img src={spyglass} alt="kikare" class="w-100% max-w-25rem sepia-50"></a>
